...
spheres = [
    {'center': np.array([144, 30, 400]), 'radius': 39, 'color': [0, 150, 0]},  # Green sphere
]
cylinders = [
    ...
    {'center': np.array([48, 0, 60]), 'direction': (np.array([0, 1, 0])), 'radius': 21, 'height': 120, 'color': [255, 255, 255]},
